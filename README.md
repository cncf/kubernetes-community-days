...
To check external links, run `make external-link-check`. This check could take several minutes and is inherently flaky given its dependence on external web resources. We recommend running it periodically and paying attention only to 404 errors.