...
* [ ] Each organizer lives in the region of the KCD location, and can easily travel to the KCD, if it were in-person. 1 organizer who serves as an advisor, may be outside the region.
* [ ] At least one organizer is a CNCF member employee, CNCF ambassador, or CNCF project maintainer. An employee of a member company counts.
* [ ] All organizers agree to follow the event guidelines and CNCF Code of Conduct
* [ ] Organizer inquiries / communication to CNCF are to come via GitHub (comment under your KCD issue) for easy tracking
